...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-deep flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gold/5 blur-[100px] rounded-full pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-serif-drama text-white mb-3">Welcome Back</h2>
          <p className="text-muted font-medium uppercase tracking-widest text-[10px]">Access your performance portal</p>
        </div>
        ...
        <div className="card-dark !p-10 border-white/5 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="btn-gold w-full py-5 text-lg shadow-gold/10"
            >
              {isSubmitting ? (
                <>
